...
import { FiBook, FiUsers, FiBriefcase } from "react-icons/fi";
...
const Sidebar = ({ className }) => {
    ...
    const Menus = [
        { title: "Dashboard", routes: route("admin-dashboard") },
        { title: "Buku", icon: <FiBook />, routes: route("admin-book") },
        {
            title: "Kategori",
            icon: <MdOutlineCategory />,
            routes: route("admin-category"),
        },
        { title: "Pengguna", icon: <FiUsers />, routes: route("admin-user") },
        {
            title: "Petugas",
            icon: <FiBriefcase />,
            routes: route("admin-petugas"),
        },
        {
            title: "Log Peminjaman",
            icon: <GoLog />,
            routes: route("admin-rentlog"),
        },
    ];
